    ...
    <>
      <section id="contact" className="relative overflow-hidden">
        ...
        <div className="container relative mx-auto flex flex-col gap-8 px-6 py-24 md:py-32 lg:gap-16 lg:py-40 xl:py-52">
          <h1 className="font-libre max-w-xl text-left text-3xl font-bold text-second [text-shadow:_2px_2px_0_rgb(0_0_0_/_40%)] md:text-4xl lg:text-6xl dark:text-light">
            Contact
          </h1>
