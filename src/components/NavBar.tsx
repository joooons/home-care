...
const navigation = [
  { name: 'Home Care', href: '#', current: true },
        ...
        <>
          <div className='mx-auto max-w-7xl px-2 sm:px-6 lg:px-8'>
            <div className='relative flex h-24 items-center justify-between'>
              ...
              <div className='absolute inset-y-0 right-0 text-xl font-medium flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0'>
                {/* Profile dropdown */}
                Contacts
              </div>
            </div>
